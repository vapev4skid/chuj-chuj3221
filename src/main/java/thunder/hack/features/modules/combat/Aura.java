...
public class Aura extends Module {
    ...
    public final Setting<Boolean> ignoreColorTeam = new Setting<>("IgnoreColorTeam", false);
    ...
    public final Setting<Float> targetDistance = new Setting<>("TargetDistance", 10.0f, 3.0f, 30.0f);
