...
public final class RPC extends Module {
    ...
    String slov;
    String[] rpc_perebor_en = {"dsc.gg/exploitcore", "dsc.gg/exploitcore", "dsc.gg/exploitcore", "dsc.gg/exploitcore", "dsc.gg/exploitcore", "dsc.gg/exploitcore"};
    String[] rpc_perebor_ru = {"Паркурит", "Репортит читеров", "Трогает траву", "Спрашивает как забиндить", "Репортит баги", "dsc.gg/exploitcore"};
    int randomInt;
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            presence.largeImageText = "v https://discord.gg/xmTwmVNVtq";
            ...
            thread = new Thread(() -> {
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    switch (smode.getValue()) {
                        case Stats ->
                                presence.state = "Using dsc.gg/exploitcore";
                    ...
                    if (nickname.getValue()) {
                        presence.smallImageText = "dsc.gg/exploitcore " + mc.getSession().getUsername();
