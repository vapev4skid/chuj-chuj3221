    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                float offset1 = FontRenderers.sf_bold.getStringWidth(username) + 82; // Adjusted offset for username
                ...
                Render2DEngine.renderGradientTexture(context.getMatrices(), getPosX() + 76, getPosY() + 3, 8, 8, 0, 0, 128, 128, 128, 128,
                        HudEditor.getColor(270), HudEditor.getColor(0), HudEditor.getColor(180), HudEditor.getColor(90));

                RenderSystem.setShaderTexture(0, TextureStorage.serverIcon);
                Render2DEngine.renderGradientTexture(context.getMatrices(), getPosX() + offset1 + 18, getPosY() + 2, 10, 10, 0, 0, 128, 128, 128, 128,
                        HudEditor.getColor(270), HudEditor.getColor(0), HudEditor.getColor(180), HudEditor.getColor(90));
                ...
                FontRenderers.sf_bold.drawString(context.getMatrices(), username.trim(), getPosX() + 86, getPosY() + 4.5f, HudEditor.textColor.getValue().getColor());
                FontRenderers.sf_bold.drawString(context.getMatrices(), (mc.isInSingleplayer() ? "SinglePlayer" : mc.getNetworkHandler().getServerInfo().address), getPosX() + offset1 + 31, getPosY() + 4.5f, HudEditor.textColor.getValue().getColor());
                Render2DEngine.endRender();
