...
public class MainMenuScreen extends Screen {
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.sf_medium.drawCenteredString(
                context.getMatrices(),
                "Version by: dsc.gg/exploitcore",
                (int) (halfOfWidth),
                (int) (halfOfHeight - 130),
...
//        FontRenderers.sf_medium.drawString(context.getMatrices(), "By Pan4ur & 06ED", halfOfWidth * 2 - FontRenderers.sf_medium.getStringWidth("By Pan4ur & 06ED") - 5f, halfOfHeight * 2 - 10, Render2DEngine.applyOpacity(-1, 0.4f));
        ...
        onlineText:
        {
            String onlineUsers = String.format("online: %s%s", Formatting.DARK_GREEN, getTotalPlayers());
        ...
        String addonsText = "Version loaded: dsc.gg/exploitcore";
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (Render2DEngine.isHovered(mouseX, mouseY, mc.getWindow().getScaledWidth() - 90, mc.getWindow().getScaledHeight() - 40, 40, 40))
            Util.getOperatingSystem().open(URI.create("https://discord.com/invite/HEMY4Ka6p7"));
