...
public class CaptureMark {
    ...
    public static void render(Entity target) {
        ...
        buffer.vertex(matrix, 0, 1.5f, 0).texture(0f, 1f).color(auraColor.getRGB());
        buffer.vertex(matrix, 1.5f, 1.5f, 0).texture(1f, 1f).color(auraColor.getRGB());
        buffer.vertex(matrix, 1.5f, 0, 0).texture(1f, 0).color(auraColor.getRGB());
        buffer.vertex(matrix, 0, 0, 0).texture(0, 0).color(auraColor.getRGB());
